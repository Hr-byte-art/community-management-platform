...
export const workOrderApi = {
  ...
  enhance: (data) => request.post('/workorder/ai/complete', data, { timeout: 120000 }),
...
export const hazardApi = {
  ...
  enhance: (data) => request.post('/hazard/ai/complete', data, { timeout: 120000 }),
...
export const appointmentApi = {
  ...
  enhance: (data) => request.post('/appointment/ai/complete', data, { timeout: 120000 }),
...
export const neighborHelpApi = {
  ...
  enhance: (data) => request.post('/neighborhelp/ai/complete', data, { timeout: 120000 }),
...
export const noticeApi = {
  ...
  mySubscriptions: () => request.get('/notice/subscription/my'),
  saveSubscriptions: (data) => request.put('/notice/subscription/my', data),
